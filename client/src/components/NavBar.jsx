            ...
            <ul>
              ...
              <li>
                <DropdownButton id="dropdown-basic-button" title="Quizz">
                  ...
                  <Dropdown.Item className="Dropdown-nav" href="/quizzChoice">Testez vos quizz</Dropdown.Item>
                </DropdownButton>
              </li>
              <li>
              ...
              <li>
                <DropdownButton id="dropdown-basic-button" title="Vie de classe">
                  ...
                  <Dropdown.Item className="Dropdown-nav" href="/putInOrder">Remise en ordre</Dropdown.Item>
                </DropdownButton>
              </li>
              <li>
        ...
        <React.Fragment>
          <nav id="navbar">
            <ul>
              ...
              <li>
              <li><a href="/quizzChoice">Quizz</a></li>
              </li>
