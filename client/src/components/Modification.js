        ...
        return (
            <React.Fragment>
                <Modal
                    ...
                    <p><input className="champConnect" placeholder="Adresse" onKeyDown={this.onKeyDown} name="address" type="text" value={this.state.address} onChange={this.onChange} pattern="[A-Za-z0-9 ',àáâãäåçèéêëìíîïðòóôõöùúûüýÿ-]+" onFocus={this.setRequired}/></p>
